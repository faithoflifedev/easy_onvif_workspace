...
StreamingCapabilities _$StreamingCapabilitiesFromJson(
  ...
  rtpStreaming: OnvifUtil.nullableStringToBool(
    json['@RTPStreaming'] as String?,
  ),
  rtpMulticast: OnvifUtil.nullableStringToBool(
    json['@RTPMulticast'] as String?,
  ),
  rtpRtspTcp: OnvifUtil.nullableStringToBool(json['@RTP_RTSP_TCP'] as String?),
