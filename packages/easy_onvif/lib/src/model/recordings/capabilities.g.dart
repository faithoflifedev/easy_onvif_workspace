...
Capabilities _$CapabilitiesFromJson(Map<String, dynamic> json) => Capabilities(
  dynamicRecordings: OnvifUtil.stringToBool(
    json['@DynamicRecordings'] as String,
  ),
  ...
  metadataRecording: OnvifUtil.nullableStringToBool(
    json['@MetadataRecording'] as String?,
  ),
  supportedExportFileFormats: OnvifUtil.nullableStringToBool(
    json['@SupportedExportFileFormats'] as String?,
  ),
  eventRecording: OnvifUtil.nullableStringToBool(
    json['@EventRecording'] as String?,
  ),
