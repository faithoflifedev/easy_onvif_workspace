...
System _$SystemFromJson(Map<String, dynamic> json) => System(
      ...
      maxStorageConfigurations:
          OnvifUtil.stringToBool(json['@MaxStorageConfigurations'] as String),
      geoLocationEntries: int.parse(json['@GeoLocationEntries'] as String),
      storageTypesSupported:
          OnvifUtil.stringToList(json['@StorageTypesSupported'] as String),
      discoveryNotSupported:
          OnvifUtil.stringToBool(json['@DiscoveryNotSupported'] as String),
      networkConfigNotSupported:
          OnvifUtil.stringToBool(json['@NetworkConfigNotSupported'] as String),
      userConfigNotSupported:
          OnvifUtil.stringToBool(json['@UserConfigNotSupported'] as String),
