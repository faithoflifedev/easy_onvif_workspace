...
MetadataConfigurationOptions _$MetadataConfigurationOptionsFromJson(
    ...
    MetadataConfigurationOptions(
      geoLocation:
          OnvifUtil.nullableStringToBool(json['@GeoLocation'] as String?),
      maxContentFilterSize:
          OnvifUtil.optionalInt(json['@MaxContentFilterSize'] as String?),
      ptzStatusFilterOptions: PtzStatusFilterOptions.fromJson(
