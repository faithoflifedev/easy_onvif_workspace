...
class NetworkCapabilities {
  ...
  @JsonKey(name: '@IPFilter', fromJson: stringToBool)
  final bool ipFilter;

  ///Indicates support for zeroconf.
  @JsonKey(name: '@ZeroConfiguration', fromJson: stringToBool)
  final bool zeroConfiguration;

  ///Indicates support for IPv6.
  @JsonKey(name: '@IPVersion6', fromJson: stringToBool)
  final bool ipVersion6;

  ///Indicates support for dynamic DNS configuration.
  @JsonKey(name: '@DynDNS', fromJson: stringToBool)
  final bool dynDNS;

  ///Indicates support for IEEE 802.11 configuration.
  @JsonKey(name: '@Dot11Configuration', fromJson: stringToBool)
